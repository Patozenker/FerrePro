    ...
    <div style={s.app}>
      ...
      <div style={s.main}>
        ...
        <main style={s.content}>
          ...
          {active==="inventario"  && <Inventario  productos={productos} setProductos={setProductos} proveedores={proveedores} setProveedores={setProveedores} categoriasExtra={categoriasExtra} setCategoriasExtra={setCategoriasExtra} editProdId={editProdId} setEditProdId={setEditProdId} historialPrecios={historialPrecios} setHistorialPrecios={setHistorialPrecios} allCats={allCats} cotizacionUSD={configAdmin.cotizacionUSD||1200}/>}
